      ...
      <div className="col-12 col-xl-7 mt-4">
        <div className="row justify-content-center p-4">
          ...
          <div className="col-12 col-xl-6 mt-4 pt-2 ">
            <h1>
              Création <span className="green">&</span> Développement web par
              Lemurian Agency
            </h1>
            <p className="lead mt-3 mb-2">
              Lemurian Agency développe des outils sur-mesure à destination des
              entreprises. Je fait un sorte de faire gagner du temps et de
              l'efficacité à nos clients en numérisant leurs processus, dans le
